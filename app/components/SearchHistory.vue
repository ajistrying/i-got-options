      ...
      >
        ...
        >
          <div class="flex items-center space-x-4 flex-1">
            ...
            <UIcon
              :name="isExpanded(tickerGroup.ticker) ? 'i-heroicons-chevron-down' : 'i-heroicons-chevron-right'"
            ...
            <UBadge size="sm" color="gray" variant="outline">
              {{ tickerGroup.searchCount }} search{{ tickerGroup.searchCount > 1 ? 'es' : '' }}
            </UBadge>
          </div>
        ...
        <!-- Expanded Content -->
        <div v-if="isExpanded(tickerGroup.ticker)" class="border-t border-gray-200 dark:border-gray-700">
          ...
          <div v-else-if="searchDetails[tickerGroup.ticker]" class="p-4 space-y-4">
            ...
            <div
              v-for="subredditResult in searchDetails[tickerGroup.ticker].combinedResults"
            ...
            >
              ...
              <div class="bg-gray-50 dark:bg-gray-800 px-4 py-2 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-between">
                  ...
                  <UBadge size="xs" color="gray">{{ subredditResult.count }} posts</UBadge>
                </div>
              </div>
